...
const BusinessAdministration = ({ navigation, route }) => {
  return (
    <ImageBackground
      blurRadius={2}
      ...
      <View style={styles.cardStyle}>
        ...
        <MenuProvider style={{ flexDirection: "column", paddingTop: 15 }}>
          <Menu
            onSelect={(value) =>
              value == "Ksb Voting"
                ? navigation.navigate("Ksb Voting", alert(`${value}`))
                : alert(`${value}`)
            }
          >
            <MenuTrigger>
              <Card>
                <View style={styles.cardViewStyle}>
                  ...
                  <Text style={styles.headerText}>
                    BUSINESS ADMINISTRATION VOTING
                  </Text>
                </View>
              </Card>
            </MenuTrigger>
            <MenuOptions>
              <MenuOption value={"Ksb Voting"}>
                <Text style={styles.menuContent}>1. K.S.B Voting</Text>
              </MenuOption>
              <MenuOption value={"Department"}>
                <Text style={styles.menuContent}>
                  2.Business.Admi Department Voting
                </Text>
              </MenuOption>
            </MenuOptions>
          </Menu>
