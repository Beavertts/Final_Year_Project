...
const MechanicalEngineering = ({ navigation, route }) => {
  return (
    <ImageBackground
    blurRadius = {2}
              ...
              <Card>
                <View style={styles.cardViewStyle}>
                  <FontAwesome5
                    ...
                    color="black"
                  />
                  <Text style={styles.headerText}>MECHANICAL ENGINEERING VOTING</Text>
                </View>
              </Card>
            </MenuTrigger>
            <MenuOptions>
              ...
              <MenuOption value={"Department"}>
                <Text style={styles.menuContent}>2.Mechanical.Eng Department Voting</Text>
              </MenuOption>
            </MenuOptions>
          </Menu>
        </MenuProvider>
