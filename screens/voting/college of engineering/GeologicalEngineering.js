...
const GeologicalEngineering = ({ navigation, route }) => {
  return (
    <ImageBackground
    blurRadius = {2}
    ...
    >
      <View style={styles.cardStyle}>
        ...
        <MenuProvider style={{ flexDirection: "column", paddingTop: 15 }}>
          <Menu onSelect={(value) => value == "CoeVoting"
                ? navigation.navigate("Coe Voting", alert(`${value}`))
                : alert(`${value}`)
            }>
            <MenuTrigger>
              <Card>
                <View style={styles.cardViewStyle}>
                  <FontAwesome5
                    ...
                    color="black"
                  />
                  <Text style={styles.headerText}>GEOLOGICAL ENGINEERING VOTING</Text>
                </View>
              </Card>
            </MenuTrigger>
            <MenuOptions>
              <MenuOption value={"CoeVoting"}>
                <Text style={styles.menuContent}>1. C.O.E Voting</Text>
              </MenuOption>
              <MenuOption value={"Department"}>
                <Text style={styles.menuContent}>2.Geological.Eng Department Voting</Text>
              </MenuOption>
            </MenuOptions>
          </Menu>
        </MenuProvider>
...
export default GeologicalEngineering;
