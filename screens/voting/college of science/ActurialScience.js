...
const ActurialScience = ({ navigation, route }) => {
  return (
    <ImageBackground
    blurRadius = {2}
    ...
    >
      <View style={styles.cardStyle}>
        ...
        <MenuProvider style={{ flexDirection: "column", paddingTop: 15 }}>
          <Menu onSelect={(value) =>
              value == "Scisa"
                ? navigation.navigate("Scisa Voting", alert(`${value}`))
                : alert(`${value}`)
            }
          >
            <MenuTrigger>
              <Card>
                <View style={styles.cardViewStyle}>
                  <FontAwesome5
                    ...
                    color="black"
                  />
                  <Text style={styles.headerText}>ACTURIAL SCIENCE VOTING</Text>
                </View>
              </Card>
            </MenuTrigger>
            <MenuOptions>
              <MenuOption value={"Scisa"}>
                <Text style={styles.menuContent}>1.Scisa Voting</Text>
              </MenuOption>
              <MenuOption value={"Department"}>
                <Text style={styles.menuContent}>2.Acturial.Sci Department Voting</Text>
              </MenuOption>
            </MenuOptions>
          </Menu>
        </MenuProvider>
